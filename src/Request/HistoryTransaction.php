...
class HistoryTransaction extends AbstractRequest implements JsonSerializable
{
    /** @var string */
    protected $url = "https://api.indx.ru/api/v2/trade/HistoryTransaction";
     ...
     * @param string     $dateEnd    End date in "YYYYMMDD" format.
